...
- If the app starts on the login screen with no data: that's expected on a fresh origin — register a throwaway account (password needs ≥8 chars with a letter and a digit) and complete onboarding to reach the shell.
